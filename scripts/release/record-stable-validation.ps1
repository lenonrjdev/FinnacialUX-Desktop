...
Invoke-FinnacialuxNativeCommand $Node @("scripts\release\stable-release.mjs", "verify-artifacts", $Root, "releases\$Version") "Os artefatos automáticos da versão 1.5.0 ainda não foram aprovados."
Invoke-FinnacialuxNativeCommand $Node @("scripts\signing\windows-signing.mjs", "verify-report", $Root, "releases\$Version\WINDOWS_AUTHENTICODE_REPORT.json") "O relatório Authenticode da versão 1.5.0 não está aprovado."
...
Write-Host "Próximo passo: .\04_PUBLICAR_ATUALIZACAO.cmd"
